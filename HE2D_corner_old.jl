...
CE = spzeros(Complex{Float64},Ndof,Ndof);
...
Mbig = spzeros(Complex{Float64},Ndof*(PE+PN+2+PE*PN),Ndof*(PE+PN+1+PE*PN));
Kbig = spzeros(Complex{Float64},Ndof*(PE+PN+2+PE*PN),Ndof*(PE+PN+1+PE*PN));
...
Kbig[Ndof*(PE+PN+PE*PN+1)+1:Ndof*(PE+PN+PE*PN+2),1:Ndof] = IMC;
