function I10(r,hx,hy,gj,pref,elref)
I = zeros((r+1)^2,(r+1)^2);
glp,glw = GLpw(r);
...
for i = 1 : size(I,1)
    ...
    for j = 1 : size(I,2)
		...
		for p = 1 : r+1
			...
			I[i,j] = I[i,j] + hy/hx*glw[p2x[1]]*basisx(jtomny[1],1,r)*(jtomnx[1] == p2x[1])*
												 basis(itomny[1],1,r)*(itomnx[1] == p2x[1]);
		end
    end
