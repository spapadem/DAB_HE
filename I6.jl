function I6(r,hx,hy,gj,pref,elref)
I = zeros((r+1)^2,(r+1)^2);
glp,glw = GLpw(r);
...
for i = 1 : size(I,1)
    ...
    for j = 1 : size(I,2)
		...
		for p = 1 : r+1
			...
			I[i,j] = I[i,j] + hy/hx*glw[q2y[1]]*basisx(jtomnx[1],1,r)*(jtomny[1] == q2y[1])*
												 basis(itomnx[1],1,r)*(itomny[1] == q2y[1]);
		end
    end
end
