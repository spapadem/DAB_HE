...
for r =  1 : 5
	...
	fprintf('r = %2d\n',r)
		if r < 5
		ure =  load(['sol_f',num2str(f),'-r',num2str(r),'-PE',num2str(10),'-PN',num2str(10),'-nLE',num2str(30),'.0-nLN',num2str(30),'.0-h',num2str(h),'.0-real.dat']);
		uie =  load(['sol_f',num2str(f),'-r',num2str(r),'-PE',num2str(10),'-PN',num2str(10),'-nLE',num2str(30),'.0-nLN',num2str(30),'.0-h',num2str(h),'.0-imag.dat']);
	ue = ure + 1i *uie;
	else
		ure =  load(['sol_f',num2str(f),'-r',num2str(r),'-PE',num2str(8),'-PN',num2str(8),'-nLE',num2str(30),'.0-nLN',num2str(30),'.0-h',num2str(h),'.0-real.dat']);
		uie =  load(['sol_f',num2str(f),'-r',num2str(r),'-PE',num2str(8),'-PN',num2str(8),'-nLE',num2str(30),'.0-nLN',num2str(30),'.0-h',num2str(h),'.0-imag.dat']);
	ue = ure + 1i *uie;
...
grid
 legend('$r = 1$','$r = 2$', '$r = 3$','$r = 4$','$r = 5$','Location','SouthWest','interpreter','latex','FontSize',14)
xlabel('P')
ylabel('E')
...
figure(3)
subplot(2,3,1)
scatter(p(:,1)/lambda_0,p(:,2)/lambda_0,15,abs(u),'filled'); 
...
colorbar
subplot(2,3,2)
scatter(p(:,1)/lambda_0,p(:,2)/lambda_0,15,(ur),'filled'); 
...
colorbar
subplot(2,3,3)
scatter(p(:,1)/lambda_0,p(:,2)/lambda_0,15,(ui),'filled'); 
...
subplot(2,3,4)
scatter(p(:,1)/lambda_0,p(:,2)/lambda_0,15,abs(ue),'filled'); 
axis equal; 
axis image;
colormap jet
colorbar
...
subplot(2,3,5)
scatter(p(:,1)/lambda_0,p(:,2)/lambda_0,15,ure,'filled');
axis equal;
axis image;
colormap jet
colorbar
...
subplot(2,3,6)
scatter(p(:,1)/lambda_0,p(:,2)/lambda_0,15,uie,'filled');
axis equal;
axis image;
colormap jet
colorbar
